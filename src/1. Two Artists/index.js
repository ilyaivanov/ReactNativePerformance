...
export default class App extends Component {
  ...
  render() {
    ...
    const artists = [
      {id: "1", url: 'https://picsum.photos/g/132/132/?length=14', name: "Artist 1", listeners: 137000, percent: 45},
      {id: "2", url: 'https://picsum.photos/g/132/132/?length=32', name: "Artist 2", listeners: 60000, percent: 25},
    ];
    return (
